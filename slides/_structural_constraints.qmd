...
![@Wagner2021](images/constrained_inversion_implementation.svg)
...
:::
::: {.column width="50%"}
![](images/DP_constraints_plus_ERT.png)
:::
::::
...
-   **Alternative way to smoothness-constrained inversions** using a covariance matrix to quantify the correlation of model parameters in different cells [@Jordi2018]
